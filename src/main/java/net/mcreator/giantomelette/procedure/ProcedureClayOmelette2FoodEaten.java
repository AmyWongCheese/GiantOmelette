...
public class ProcedureClayOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureClayOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 152);
	}
