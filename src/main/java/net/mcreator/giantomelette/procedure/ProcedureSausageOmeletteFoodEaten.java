...
public class ProcedureSausageOmeletteFoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureSausageOmeletteFoodEaten(ElementsGiantOmelette instance) {
		super(instance, 192);
	}
