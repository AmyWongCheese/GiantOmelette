...
public class ProcedureTwirlyFruitOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureTwirlyFruitOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 219);
	}
