...
public class ProcedurePizzaOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedurePizzaOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 187);
	}
