...
public class ProcedureChocolateOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureChocolateOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 145);
	}
