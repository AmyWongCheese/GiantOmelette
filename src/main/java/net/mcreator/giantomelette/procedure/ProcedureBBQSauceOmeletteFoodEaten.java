...
public class ProcedureBBQSauceOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureBBQSauceOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 134);
	}
