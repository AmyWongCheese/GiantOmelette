...
public class ProcedureHamAndCheeseOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureHamAndCheeseOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 160);
	}
