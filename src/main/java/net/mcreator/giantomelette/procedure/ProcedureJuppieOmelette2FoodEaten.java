...
public class ProcedureJuppieOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureJuppieOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 172);
	}
