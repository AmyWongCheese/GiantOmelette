...
public class ProcedureTwirlyFruitOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureTwirlyFruitOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 218);
	}
