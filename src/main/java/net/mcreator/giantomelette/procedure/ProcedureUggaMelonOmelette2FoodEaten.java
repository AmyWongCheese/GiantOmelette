...
public class ProcedureUggaMelonOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureUggaMelonOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 222);
	}
