...
public class ProcedureBlackCurrantOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureBlackCurrantOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 139);
	}
