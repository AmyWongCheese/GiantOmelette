...
public class ProcedureChokatoOmeletteFoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureChokatoOmeletteFoodEaten(ElementsGiantOmelette instance) {
		super(instance, 148);
	}
