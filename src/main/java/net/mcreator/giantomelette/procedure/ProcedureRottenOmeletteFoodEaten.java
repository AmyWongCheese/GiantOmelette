...
public class ProcedureRottenOmeletteFoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureRottenOmeletteFoodEaten(ElementsGiantOmelette instance) {
		super(instance, 129);
	}
