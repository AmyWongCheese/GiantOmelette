...
public class ProcedureUggaMelonOmelette3FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureUggaMelonOmelette3FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 224);
	}
