...
public class ProcedureMeatFeastOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureMeatFeastOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 180);
	}
