...
public class ProcedureSausageAndPepperoniOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureSausageAndPepperoniOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 196);
	}
