...
public class ProcedureCarrotAndPeaOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureCarrotAndPeaOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 141);
	}
