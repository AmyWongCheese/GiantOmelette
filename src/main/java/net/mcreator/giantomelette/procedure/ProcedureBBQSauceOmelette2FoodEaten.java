...
public class ProcedureBBQSauceOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureBBQSauceOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 135);
	}
