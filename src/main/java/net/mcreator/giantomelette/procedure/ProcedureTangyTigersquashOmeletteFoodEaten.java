...
public class ProcedureTangyTigersquashOmeletteFoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureTangyTigersquashOmeletteFoodEaten(ElementsGiantOmelette instance) {
		super(instance, 208);
	}
