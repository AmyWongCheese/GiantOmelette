...
public class ProcedureJuppieOmeletteFoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureJuppieOmeletteFoodEaten(ElementsGiantOmelette instance) {
		super(instance, 171);
	}
