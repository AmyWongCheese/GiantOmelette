...
public class ProcedureMushroomOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureMushroomOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 183);
	}
