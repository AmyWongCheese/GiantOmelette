...
public class ProcedureTangyTigersquashOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureTangyTigersquashOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 209);
	}
