...
public class ProcedureLittleFishyOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureLittleFishyOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 175);
	}
