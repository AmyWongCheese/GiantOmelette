...
public class ProcedureGreenPepperOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureGreenPepperOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 157);
	}
