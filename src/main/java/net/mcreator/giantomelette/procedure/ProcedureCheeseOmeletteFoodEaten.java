...
public class ProcedureCheeseOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureCheeseOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 130);
	}
