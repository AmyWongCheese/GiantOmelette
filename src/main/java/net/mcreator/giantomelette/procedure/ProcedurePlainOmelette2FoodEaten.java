...
public class ProcedurePlainOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedurePlainOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 113);
	}
