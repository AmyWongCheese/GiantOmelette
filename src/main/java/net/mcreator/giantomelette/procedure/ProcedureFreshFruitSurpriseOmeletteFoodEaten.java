...
public class ProcedureFreshFruitSurpriseOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureFreshFruitSurpriseOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 154);
	}
