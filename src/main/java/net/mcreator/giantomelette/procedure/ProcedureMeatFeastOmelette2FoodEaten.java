...
public class ProcedureMeatFeastOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureMeatFeastOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 181);
	}
