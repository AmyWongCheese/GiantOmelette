...
public class ProcedurePizzaOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedurePizzaOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 186);
	}
