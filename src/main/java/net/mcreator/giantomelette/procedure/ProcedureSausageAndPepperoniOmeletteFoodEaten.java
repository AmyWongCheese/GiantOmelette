...
public class ProcedureSausageAndPepperoniOmeletteFoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureSausageAndPepperoniOmeletteFoodEaten(ElementsGiantOmelette instance) {
		super(instance, 195);
	}
