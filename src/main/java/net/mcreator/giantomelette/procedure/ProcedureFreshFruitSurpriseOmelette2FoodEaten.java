...
public class ProcedureFreshFruitSurpriseOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureFreshFruitSurpriseOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 155);
	}
