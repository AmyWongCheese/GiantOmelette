...
public class ProcedureHoneyBlossomOmeletteFoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureHoneyBlossomOmeletteFoodEaten(ElementsGiantOmelette instance) {
		super(instance, 163);
	}
