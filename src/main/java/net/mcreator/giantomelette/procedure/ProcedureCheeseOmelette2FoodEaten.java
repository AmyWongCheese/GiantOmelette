...
public class ProcedureCheeseOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureCheeseOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 131);
	}
