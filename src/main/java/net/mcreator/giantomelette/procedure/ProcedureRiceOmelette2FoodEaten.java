...
public class ProcedureRiceOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureRiceOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 190);
	}
