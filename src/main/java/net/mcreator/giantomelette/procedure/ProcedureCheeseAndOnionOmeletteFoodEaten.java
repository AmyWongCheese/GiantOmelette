...
public class ProcedureCheeseAndOnionOmeletteFoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureCheeseAndOnionOmeletteFoodEaten(ElementsGiantOmelette instance) {
		super(instance, 142);
	}
