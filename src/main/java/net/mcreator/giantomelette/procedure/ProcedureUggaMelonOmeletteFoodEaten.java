...
public class ProcedureUggaMelonOmeletteFoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureUggaMelonOmeletteFoodEaten(ElementsGiantOmelette instance) {
		super(instance, 221);
	}
