...
public class ProcedureBaconAndBroccoliOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureBaconAndBroccoliOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 132);
	}
