...
public class ProcedureHotTyrannianPepperOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureHotTyrannianPepperOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 166);
	}
