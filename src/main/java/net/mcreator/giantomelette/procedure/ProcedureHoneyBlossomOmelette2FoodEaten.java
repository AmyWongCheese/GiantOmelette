...
public class ProcedureHoneyBlossomOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureHoneyBlossomOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 164);
	}
