...
public class ProcedureBaconAndBroccoliOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureBaconAndBroccoliOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 133);
	}
