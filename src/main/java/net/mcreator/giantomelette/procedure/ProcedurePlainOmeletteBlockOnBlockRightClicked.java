...
public class ProcedurePlainOmeletteBlockOnBlockRightClicked extends ElementsGiantOmelette.ModElement {
	public ProcedurePlainOmeletteBlockOnBlockRightClicked(ElementsGiantOmelette instance) {
		super(instance, 233);
	}
