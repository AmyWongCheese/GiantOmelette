...
public class ProcedureRiceOmeletteFoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureRiceOmeletteFoodEaten(ElementsGiantOmelette instance) {
		super(instance, 189);
	}
