...
public class ProcedureGetHotTyrannianPepper extends ElementsGiantOmelette.ModElement {
	public ProcedureGetHotTyrannianPepper(ElementsGiantOmelette instance) {
		super(instance, 237);
	}
