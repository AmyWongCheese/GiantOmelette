...
public class ProcedureHotTyrannianPepperOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureHotTyrannianPepperOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 167);
	}
