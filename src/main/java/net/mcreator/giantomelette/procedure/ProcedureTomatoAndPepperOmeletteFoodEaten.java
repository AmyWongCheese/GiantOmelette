...
public class ProcedureTomatoAndPepperOmeletteFoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureTomatoAndPepperOmeletteFoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 215);
	}
