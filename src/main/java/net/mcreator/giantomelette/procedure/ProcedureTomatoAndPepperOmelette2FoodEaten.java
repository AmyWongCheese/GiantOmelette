...
public class ProcedureTomatoAndPepperOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureTomatoAndPepperOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 216);
	}
