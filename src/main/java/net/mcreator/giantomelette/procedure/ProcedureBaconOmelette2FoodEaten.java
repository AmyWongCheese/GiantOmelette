...
public class ProcedureBaconOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureBaconOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 137);
	}
