...
public class ProcedureSpinachFetaOmelette2FoodEaten extends ElementsGiantomeletteMod.ModElement {
	public ProcedureSpinachFetaOmelette2FoodEaten(ElementsGiantomeletteMod instance) {
		super(instance, 203);
	}
