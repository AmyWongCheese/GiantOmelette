...
public class ProcedureSausageOmelette2FoodEaten extends ElementsGiantOmelette.ModElement {
	public ProcedureSausageOmelette2FoodEaten(ElementsGiantOmelette instance) {
		super(instance, 193);
	}
