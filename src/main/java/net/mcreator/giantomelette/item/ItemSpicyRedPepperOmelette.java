...
public class ItemSpicyRedPepperOmelette extends ElementsGiantOmelette.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("giantomelette:spicyredpepperomelette", "inventory"));
	}
	public static class ItemFoodCustom extends ItemFood {
		public ItemFoodCustom() {
			super(4, 0.3f, false);
			setUnlocalizedName("spicyredpepperomelette");
			setRegistryName("spicyredpepperomelette");
		...
		protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureSpicyRedPepperOmeletteFoodEaten.executeProcedure($_dependencies);
			}
		}
	}
}
