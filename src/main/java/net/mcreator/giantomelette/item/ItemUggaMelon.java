...
public class ItemUggaMelon extends ElementsGiantOmelette.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("giantomelette:uggamelon", "inventory"));
	}
	public static class ItemFoodCustom extends ItemFood {
		public ItemFoodCustom() {
			super(1, 0.3f, false);
			setUnlocalizedName("uggamelon");
			setRegistryName("uggamelon");
		...
		protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureUggaMelonFoodEaten.executeProcedure($_dependencies);
			}
		}
	}
}
